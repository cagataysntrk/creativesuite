...
deneme_sayaci: {}
son_kanit: "TASIYICILAR ATMOSFER OLARAK CIZILIYORDU — DORDU DE GORUNMUYORDU. Dort sureklilik tasiyicisi olculdu: alanSiniri (akan-alan, karsilastirma) role-bg ile role-line-edge arasinda DELTA-L 0,03 — kimligi iki renk alani olan bir sablonun iki alani ayni renkti. kemer (kavis) AKSAN renginin %10 opakligiyla, yani neredeyse siyah bir zeminde mavi bir sis. egri (veri-hikayesi) stroke-width 0.22 ile — vector-effect non-scaling-stroke genisligi CIHAZ pikseline ceviriyor ve 0,22 alt piksele dusuyor; arastirmarin IKINCI EN GUCLU tasiyicisi hic cizilmiyordu. Ustelik dolgusu bir linearGradient idi ve D-318 degradeyi zaten emekli etmisti: karar verildi, uygulama takip etmedi. KOK TEK: dizayn sisteminin dili yuzey adimi + 1 px hairline (D-319) ve uygulama iki karari da gormezden geliyordu. Hepsi duzeltildi ve CIZILIP BAKILDI: akan-alanin dalgasi alti slaydi kat ediyor, kavisin kemerleri mimari bir ritim kuruyor, veri-hikayesinin egrisi okunur bir hat oldu. OLCUT IKI KEZ SECILDI VE ILKI YANLISTI: iki alanin MEDYAN farki editoryali kirmiziya dondurdu, oysa onun genligi KASTEN nazik ve sinirini hairline tasiyor — kural iki aygittan BIRINI istiyor. Dogru olcu KENAR GUCU. Esik 25 olculdu: duzeltmeden sonra kenar medyanlari 44/57/60/230, akan-alan oncesinde ~8. Kasten ihlal edildi, kenar gucu 5 ile kirmiziya dondu. AYRICA: text-wrap balance denendi ve OLCUM KAYDA DEGER BULMADI (%64 to %66) — global bir ozellik icin gerekce yok. 47 kapi, 2168 test."
```
