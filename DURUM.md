...
deneme_sayaci: {}
son_kanit: "DUZENLEYICI IKI MODA CIKTI VE URETILMIS KAROSEL ARTIK ACILABILIYOR (just duzenle). Sablon modu alti taslagi, KOSU modu gercek bir uretimi aciyor; ikisi ayni tezgahta, secilebilir. Kanit: gercek bir kosunun karoseli acildi, gorsel suruklendi, kaydedildi ve dort slayt 1080x1350 olarak YENIDEN CIZILDI (slayt-NN-elle.png). IKI GERCEK KOPUKLUK BULUNDU VE ONARILDI. (1) D-302: kompozisyon belgesi HICBIR YERE yazilmiyordu - defterde yalniz ozet vardi, PNG'ler duruyordu ama onlari ureten VERI yoktu, yani uretilmis bir karosel bir daha acilamiyordu. Belgeyi oldugu gibi yazmak da yanlisti: olculdu, 3299 KB (gorseller 2741 KB data URI, fontCss 552 KB base64) ve derived/runs git'te izleniyor. Ayrim tekrar uretilebilirlik: font markadan yeniden kuruluyor (yazilmiyor), gorseller uretildi (yan dosyaya PNG, byte'lar gitignore). Sonuc 3299 KB -> 7 KB. (2) D-303: BOLUM 01 sayaclari geri gelmisti - kok neden uyarlama isteminin JSON ORNEGI hala \"ustBaslik\": \"BOLUM 01\" diyordu ve model dort kartin dordune de kopyaladi. Istem artik yasagi yaziyor, uyarla sayac gelirse REDDEDIYOR; kural konunca YEDI eski test kirmizi dondu cunku fixture'lar yasak bicimi kodluyordu. GERCEK KOSUYLA DOGRULANDI: ust basliklar artik BES SART / KAYIT SORUNU / VERI DURUMU / DONGUYE GIRIS. 43 kapi yesil. ACIK (BORCLAR D15-D17): sablon modu katalog dosyasina yazmiyor, oneri basiyor; gorsel en/boy orani serbest; paneller, lekeler, oklar ve kart zemini duzenlenemiyor."
```
