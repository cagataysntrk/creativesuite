...
deneme_sayaci: {}
son_kanit: "VARLIKLAR GRUPLANDI, ONAY BOLUMLERI GELDI, SILME = KARANTINA. (1) 305 satirlik duz liste icindekini GIZLIYORDU: dort slayt tek bir gonderidir ve tek basina bir slaytin anlami yok; kullanicinin sordugu soru 'hangi gonderi', liste 'hangi dosya' cevapliyordu. Artik kosuya gore gruplu: 75 gonderi · 305 slayt, her grup konusuyla, slaytlari URETIM SIRASINDA, grup basinda hat · slayt sayisi · tarih · yayin durumu · kusurlu manifest uyarisi · 'ac' dugmesi. Grup 'yayinlandi' ancak HEPSI yayinlandiysa: uc slayti yayinlanmis bir karosel yayinlanmamistir, yarim kalmistir. (2) FILTRE + TOPLU SECIM: hat · durum (yayinlandi/yayinlanmadi/kusurlu) · son 7 gun · arama. (3) SILME = KARANTINA ve bu senkron kalmanin TEK yolu: manifest digest'i KANIT olarak tasiyor (§13); byte'i yok etmek defteri sarkan bir isaretciyle birakirdi ve panel kirik gorsel gosterirdi. Karantina zaten 'yayinlanamaz ama korunur' demek (D-155). Sebep ZORUNLU ve defterе append-only yaziliyor: gerekcesiz karantina, alti ay sonra 'bu neden burada' sorusunu cevapsiz birakir. (4) ONAY BOLUMLERI: bekleyen · onaylanan · yayinlanan · planlanan. Kuyruk yalniz bekleyeni gosteriyordu; onaylanan bir gonderi listeden dusuyor ve 'onayladim da ne oldu' sorusunun cevabi hicbir yerde olmuyordu. Kararlar zaten manifestte, eksik olan onlari okuyan bir uctu (/api/kararlar). ⚠ Yayinlanan ve planlanan bolumleri BOS DEGIL, 'henuz olculmedi' diyor: bos bir sekme 'hic yayin yok' diye okunur, oysa dogru bilgi kanal API'sinin baglanmadigi. Olculmemis bir seyi sifir gostermek bu deponun tekrar eden en pahali yanlisi."
```
