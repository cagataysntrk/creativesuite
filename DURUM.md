...
deneme_sayaci: {}
son_kanit: "19.6 RENK KAPANDI. Faz maddesi marka mavisi ustune beyaz govde YASAK (4,07<4,5) diyordu; once ihlal VAR MI diye olctum ve o vaka HICBIR destede yoktu — ama ayni olcum daha genel bir acik buldu: govde metni ARKASINDA GERCEKTEN BOYANAN yuzeye karsi 4,5i gecmiyordu. Uc katmanda cozuldu. (1) Soluk adimi artik ZEMINDEN turuyor: --role-soluk-koyu yaninda koyu kanvasta 7,12:1 yaziyordu ama o olcu TEK BIR KANVASA goreydi ve bes palet hic olculmemis zeminler getirdi; kavis beton-taban (L=0,380) orta ton ve orada ayni renk 3,48 veriyordu. Kural: koyu zemin orta tondaysa adim yukari, acik zeminde bir basamak koyu. kavis 3,16-3,42 -> 7,18-7,65. Acik dalda once 0,85 esigi yazildi, editoryal 4,12de kaldi; tahmin edilmis esik yerine YONU GARANTI olan kural secildi ve olu sabit sokuldu. (2) KARAR: .govde rengi --kart-soluk -> --kart-metin. Kusur adimin DEGERINDE degil ATAMASINDAYDI: soluk ALT YAZI rengidir, govde ICERIKTIR. Govde kontrasti ~4,1 -> 8,3-17,6, on destede de esik ustu; cizildi ve BAKILDI, hiyerarsi bozulmadi cunku onu renk degil BOYUT tasiyor. (3) Sonuk liste satiri opacity 0,38 gozle secilmisti ve yorumu okunuyor ama yarismiyor diyordu; olcum okunMADIGINI soyledi (2,45-3,31). Uc deger olculdu, 0,62 secildi (4,92); yanik satir olmuyor cunku ayrimi uc sinyal tasiyor. Yeni kapi okuma-kontrasti: CSS agacini YURUMUYOR, ekran goruntusunden luminans histogrami cikariyor; 10/10 yesil ve kasten ihlalle kirmiziya donduruldu. ALET UC KEZ UST USTE YALAN SOYLEDI: getComputedStyle oklch cozmuyor (91/91 oge 2,16 okundu), CSS agacindan zemin aramak alinti k3e 1,00 dedi, panorama acilmadan alinan goruntu on desteyi birden yanlis kirmiziya cevirdi. Bu fazda gozle secilip hic olculmemis UC sayi cikti."
