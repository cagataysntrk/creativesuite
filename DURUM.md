...
deneme_sayaci: {}
son_kanit: "SABLON AILESI ALTIDAN ONA CIKTI: kavis (kemer dizisi, geometri onculu) · alinti (yalniz tipografi, kagit, ailenin sessiz uyesi) · karsilastirma (tek yonlu alan supurmesi, once/sonra) · dizin (akis oklari, numarali adimlar). DORDU DE GORSELSIZ ve bu bir kisit degil karar: mevcut altinin besi gorsele dayaniyordu, aile geometri ve tipografiyle tasiyan uyelere muhtacti — hem cesitlilik hem saglayicisiz kosuda uretilebilen cikti icin. KURULU KAPILAR ANINDA KONUSTU (hayalet uc sablonda basliga carpti, alan siniri karsilastirmada rayi yuttu, alintide etiket panelini yuttu) AMA ASIL UC BULGUYU GOZ BULDU ve ucu de ESKI sablonlari da etkiliyordu: (1) kemer tasiyicisi modelde vardi hicbir sablon kullanmiyordu ve geometrisi kirikti — mutlak piksel, preserveAspectRatio none dikeyi %41e sikistiriyor, 132 pxlik tepe ekranda 55 px. Kullanilmamasinin sebebi tercih degil KOORDINAT UZAYIYDI. (2) Oklar yon vermiyordu: basinc 0,18+0,82sin(tpi) simetrikti, iki ucu da ince — bir MERCEK. Dosyanin kendi yorumu yon kivrimdan okunuyor diyordu ve yanlisti. (3) CUBUK GRAFIGI VERI TASIMIYORDU: kart bir flex sutunu ve align-items flex-start, panelin eni icerigine kilitli, cubuk-yuva flex 1 buyuyecek bosluk bulamiyor — yuva veri-hikayeside 10 PX, uc ayri deger (62/71/58) ayni minik kare. max-width cozmuyor cunku max bir TAVAN. width 100% eklendi, yuva 631 px. AYRICA etiket sutunu sabit genislikti ve Turkce etiketi kirpiyordu (R-23). VE ikon kok eslesmesi UNSUZ YUMUSAMASINI bilmiyordu: esik koku esigi kelimesiyle eslesmiyordu — i.toUpperCase ailesinden bir hata. Yeni kural son unsuzu esnetiyor, sinir YAZILI (unlu dusmesi kapsam disi) ve test sinira da bakiyor. YENI SABLON YAZMAK ESKI SABLONLARIN DENETIMIDIR. On sablon sifir kusur, on kapak yan yana BAKILDI, aile tutarli. 47 kapi."
```
