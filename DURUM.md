...
deneme_sayaci: {}
son_kanit: "GORSEL SABLON DUZENLEYICI PROTOTIPI CALISIYOR (just duzenle). Ayni render motoru iframe icinde; metne tiklanip yaziliyor, gorsel kutusu suruklenip Shift ile olcekleniyor, kesim cizgileri parent katmaninda gosteriliyor, panorama denetimi canli kosuyor ve degisiklik VERIYE yaziliyor (DOM'a degil). Playwright ile olculdu: tasima x %22,89 / y %40 tam isabet, sifir surukleme kaydirmiyor (birikme yok), Shift yalniz genislige dokunuyor, metin DOGRU karta gidiyor ve **vurgu** isareti korunuyor, alti sablon arasi gecis calisiyor, sayfa hatasi yok. DORT GERCEK HATA BULUNDU VE DUZELTILDI: (1) surukleme olcegi IKI KEZ sayiyordu - olcek iframe ELEMENTINE uygulandigi icin iframe ici koordinatlar zaten olceksiz; (2) style.left konumlanmis ataya, getBoundingClientRect goruntu alanina goreydi, aradaki 40px her surukleyiste birikiyordu; (3) kart indeksi dort seciciyi duz sayiyordu, kart 0'in basligi kartlar[1]'e yaziliyordu; (4) innerText **vurgu** isaretini siliyordu, <strong>'dan geri kuruluyor. AYRICA: sablon dizesi ICINDEKI yorumda backtick kullanmak dizeyi kapatti - bu tuzagin DORDUNCU tekrari. ACIK (BORCLAR D15-D17): kaydetme yolu bagli degil, JSON onizlemesi basiyor; gorsel en/boy orani serbest; paneller, lekeler, oklar ve kart zemini duzenlenemiyor."
```
