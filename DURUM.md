...
deneme_sayaci: {}
son_kanit: "PANEL BILGI MIMARISI KURULDU — eksik olan sey susleme degil, DURUMUN KENDISIYDI. Panel 'run_01a0160e · metin-onayi' gosteriyordu: bu bir KOD, bir durum degil ve kullanici 'bu is nerede, ne bekliyor, ne yapabilirim' sorularinin hicbirini cevaplayamiyordu. (1) ASAMA GOSTERGESI: hattin 25 adimi var ama insanin umursadigi sinir ADIM degil KAPI — metin, tasarim, yayin. Uc durum gosteriliyor (gecildi ✓ · burada ● · henuz ○); ikisiyle 'su an nerede' cevapsiz kaliyordu. Asama kapi ADINDAN turuyor, ayri bir alandan degil: ikinci bir alan, kapilarla asamalarin bir gun ayrismasi demekti. (2) KOMUTA artik gosterge paneli: tiklanabilir sayac seridi (sira sende bugun · bayat · uretilmis varlik · yeni uret), ASAMA DAGILIMI (hangi asamada kac is sikisti - darbogaz bir bakista), sira sende listesi (asama + bekleme suresi + kusurlu manifest uyarisi) ve son uretilen KAROSEL bir SET olarak. Tiklanamayan bir gosterge rapordur; komuta merkezi rapor degildir. (3) ONAYLAR: filtreler geldi (hat · asama · yalniz bugunku is) cunku 62 satirlik liste filtresiz okunamaz; 'harcanan $0.00' sutunu BEKLEME SURESIYLE degistirildi (bedava seritte maliyet hicbir sey soylemiyordu, bekleme soyluyor); satir ici hizli onay dugmesi. Suzme EKRANDA, sunucuda degil: kuyruk sozlesmesi korunuyor. (4) ALT SERIT YALAN SOYLEMIYORDU, YANLIS ETIKETLIYDI: 'bekleyen onay 5' derken kuyrukta 61 kapi vardi cunku o sayi CORPUS TASLAKLARINI sayiyor (R-14). Tek kelimenin iki anlami, olcumun kendisinden cok yanlis anlasilma uretir; ikiye ayrildi: 'bekleyen kapi' ve 'taslak kayit'."
```
