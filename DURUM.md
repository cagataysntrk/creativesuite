...
deneme_sayaci: {}
son_kanit: "FAZ-12.10 KAPANDI. shape-outside YAZILMADI ve sebebi yapisal: float bir flex ogesinde YOK SAYILIR (.icerik flex sutunu), polygon() float in kendi kutusuna gore ve kutu egriyle ayni y-araligini kaplamazsa poligon EZILIR — garanti geometrik kurgudan ARGUMANA doner; y-araligi ancak flex-start yaslamada belirli ve gramerdeki DORT duzenin hicbiri flex-start degil. Yazilsaydi tuketicisi olmayan yetenek + zayiflamis garanti. AMA ADIMIN AMACI TESLIM EDILDI: sutun artik O SLAYTIN egrisinden turuyor. Kuresel %62 bes slaytin EN KOTUSUYDU; icerik genisligi 582 -> 606 -> 630 -> 655 -> 679 px, ilk slayt degismiyor. Zarf PATH TEN okunuyor formulden degil: merkez-genlik yazsaydim egriye daha iceride bir kontrol noktasi eklendiginde sayi sessizce yalan olurdu. Kubik Bezier disbukey zarfini asmaz, zarf gercek egriden GENIS — yanilma yonu guvenli. column_in_band KENDI KENDINI olcuyordu (sutun da egri de ayni sabitlerden, isaret hep ayni, hicbir girdide kirmiziya donemezdi); ikisi de artik ARTEFAKTTAN: kolonPx DOM daki .icerik kutusu, egriPx ayni HTML e basilmis path in zarfi. floor kullaniliyor cunku dogru deger tam 0 ve 0.3 px lik rect gurultusu kapiyi kirmiziya cevirirdi (R-80). IHLAL TURU: sutun 6 puan genisletildi -> bes slaytta da 64 px SINIR DISI (eski surum bu ihlalde YESIL kaliyordu), geri alindi -> yesil. 6 test. FAZ-12 de kalan: 12.2 raster ilkelleri, 12.8 BLOKE:karar."
```
