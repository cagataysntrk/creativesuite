...
console.log('    4. cd <hedef> && pnpm install --frozen-lockfile')
console.log('    5. just setup   → git kancaları (yoksa commit kapıları DEVRE DIŞI)')
console.log('    6. just reindex → türetilmiş indeks (clone ile gelmez)')
console.log('    7. just verify  → TAM doğrulama; `just check` DAR ve kusur gizler')
console.log('')
